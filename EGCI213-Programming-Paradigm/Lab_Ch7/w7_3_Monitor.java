...
abstract class MyAbstractThread extends Thread
{
    ...
    //finish.reach();
    int x = -1;
	try { x = cfinish.await();} catch (Exception e) { } // calling cfinish.awwait is specify the waiting point
...
class w7_3_Monitor
{
    public static void main(String[] args)
    {
        ...
        int round = 3;
        P1.setBuffer(bufferMain);  P1.setRounds(round);
        C1.setBuffer(bufferMain);  C1.setRounds(round);
        C2.setBuffer(bufferMain);  C2.setRounds(round);
