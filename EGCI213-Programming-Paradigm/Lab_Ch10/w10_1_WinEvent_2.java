...
class w10_1_WinEvent_2 extends JFrame implements MouseListener {
    ...
    private String[] birds = {"black.png", "blue.png", "green.png", "red.png", "white.png", "yellow.png"};
    ...
    public w10_1_WinEvent_2() {
        ...
        class MyWindowListener extends WindowAdapter {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                QuickDialog2.show("Total birds = " + count);
            }
        }
...
class MyContainerListener2 extends ContainerAdapter {
    ...
    public void componentAdded(ContainerEvent e) {
        ...
        if (count % 5 == 0) {
            ...
            // label.setBackground(new Color(0, 0, 100, 50)); // transparency example
        }
    }
}